...
class Reports extends BaseDBModel
{
     ...
     */
    public function create(int $reporter_id, int $reported_id, int $listing_id): bool
    {
        $stmt = $this->db->prepare(<<<SQL
        INSERT INTO user_reports (reported_id, reported_id, listing_id) VALUES (:reporter_id, :reported_id, :listing_id)
        SQL);
